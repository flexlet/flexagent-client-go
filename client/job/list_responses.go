...
func (o *ListOK) Error() string {
	return fmt.Sprintf("[GET /jobs][%d] listOK  %+v", 200, o.Payload)
}
...
func (o *ListBadRequest) Error() string {
	return fmt.Sprintf("[GET /jobs][%d] listBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListUnauthorized) Error() string {
	return fmt.Sprintf("[GET /jobs][%d] listUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListForbidden) Error() string {
	return fmt.Sprintf("[GET /jobs][%d] listForbidden  %+v", 403, o.Payload)
}
...
func (o *ListNotFound) Error() string {
	return fmt.Sprintf("[GET /jobs][%d] listNotFound  %+v", 404, o.Payload)
}
...
func (o *ListInternalServerError) Error() string {
	return fmt.Sprintf("[GET /jobs][%d] listInternalServerError  %+v", 500, o.Payload)
}
