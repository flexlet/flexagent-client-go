...
func (o *DeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /jobs/{urn}][%d] deleteOK  %+v", 200, o.Payload)
}
...
func (o *DeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /jobs/{urn}][%d] deleteBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /jobs/{urn}][%d] deleteUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteForbidden) Error() string {
	return fmt.Sprintf("[DELETE /jobs/{urn}][%d] deleteForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /jobs/{urn}][%d] deleteNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /jobs/{urn}][%d] deleteInternalServerError  %+v", 500, o.Payload)
}
